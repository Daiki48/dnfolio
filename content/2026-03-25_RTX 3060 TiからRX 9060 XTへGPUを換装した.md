...
普段使っているKdenliveも、GPU換装に合わせて `NVENC` から `VAAPI` への切り替えが必要だった。アプリ側の対応は [RX 9060 XTへ換装したのでKdenliveの設定をNVENCからVAAPIへ切り替えた](/posts/kdenlive-nvenc-to-vaapi-after-rx9060xt/) にまとめた。
