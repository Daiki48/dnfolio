...
{{ card(title="個人サイトのdnfolioを大きく改修した", url="https://dnfolio.dev/ge-ren-saitonodnfoliowoda-kikugai-xiu-sita/") }}
...
{{ card(title="htmldjangoファイルのフォーマットに成功した | dnfolio", url="https://dnfolio.dev/htmldjangohuairunohuomatutonicheng-gong-sita/") }}
...
{{ card(title="個人サイト開発にcargo-makeを導入した", url="https://dnfolio.dev/ge-ren-saitokai-fa-nicargo-makewodao-ru-sita/") }}
