...
[個人サイトのdnfolioを大きく改修した](https://dnfolio.me/ge-ren-saitonodnfoliowoda-kikugai-xiu-sita/)
...
[Releases | dnfolio GitHub](https://github.com/Daiki48/dnfolio/releases)
...
[v4.7.0 | Releases](https://github.com/Daiki48/dnfolio/releases/tag/v4.7.0)
...
[htmldjangoファイルのフォーマットに成功した | dnfolio](https://dnfolio.me/htmldjangohuairunohuomatutonicheng-gong-sita/)

## `v4.8.0` で `cargo-make` を導入

[v4.8.0 | Releases](https://github.com/Daiki48/dnfolio/releases/tag/v4.8.0)

これも記事を書いた。

[個人サイト開発にcargo-makeを導入した](https://dnfolio.me/ge-ren-saitokai-fa-nicargo-makewodao-ru-sita/)
...
[v4.9.0 | Releases](https://github.com/Daiki48/dnfolio/releases/tag/v4.9.0)

`Zola` はアンカーリンクの生成を簡単に行える。

[Anchor insertion | Zola](https://www.getzola.org/documentation/content/linking/#anchor-insertion)
...
[v4.10.0 | Releases](https://github.com/Daiki48/dnfolio/releases/tag/v4.10.0)
...
[v4.11.0 | Releases](https://github.com/Daiki48/dnfolio/releases/tag/v4.11.0)

`Zola` ドキュメントに書かれていたので導入してみた。

[Archive | Zola](https://www.getzola.org/documentation/templates/archive/)
